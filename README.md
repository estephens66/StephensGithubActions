[![Run App Stephens, Egen](https://github.com/estephens66/StephensGithubActions/actions/workflows/ci.yml/badge.svg)](https://github.com/estephens66/StephensGithubActions/actions/workflows/ci.yml)
